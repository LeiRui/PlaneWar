...
public class StrongPlane extends Plane{
    public StrongPlane(int x, int y, int w, int h){
        super(x,y,w,h, ConstantUtil.ImgEnemyStrongURL,ConstantUtil.PlaneType.GeneralStrongEnemy);
        life=2; // 生命值增加
